...
vector<int> find_cost(const string &x,const string &y);
...
int Hirschberg(const string &x,const string &y)
{
    ...
    else
    {
        ...
        cost1=find_cost(temp1,y);
        cost2=find_cost(temp2,temp3);
...
int main()
{
    ...
    //int countA = 0;
    //int countB = 0;
    freopen("Lab05-TestCase/Data-P3a.txt","r",stdin);
	cin >> A;
    cin.clear();

    freopen("Lab05-TestCase/Data-P3b.txt","r",stdin);
	cin >> B;
